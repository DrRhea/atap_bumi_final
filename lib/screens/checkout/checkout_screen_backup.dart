                  ...
                  child: _shippingMethod == 'Pickup' 
                      ? const Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text(
                              "Jl. Raya Ubud No. 88, Gianyar, Bali 80571",
                              style: TextStyle(
                                fontSize: 14,
                                color: Color(0xFF64748B),
                                fontFamily: 'Alexandria',
                      ...
                      : const Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text(
                              "Jl. Gatot Subroto No. 42, RT 04/RW 02, Kelurahan Menteng, Kecamatan Menteng, Jakarta Pusat 10310",
                              style: TextStyle(
                                fontSize: 14,
                                color: Color(0xFF64748B),
                                fontFamily: 'Alexandria',
  ...
  Widget _buildBottomCheckout() {
    return Consumer<CartProvider>(
      builder: (context, cartProvider, child) {
        ...
        final shippingFee = _shippingMethod == 'Pickup' 
            ? 0.0 
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: cartProvider.cartItems.isNotEmpty
                        ? () {
                            final total = cartProvider.selectedTotalPrice + _getShippingFee();
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                    ...
                    child: Ink(
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: cartProvider.cartItems.isNotEmpty
                            ? [
                                BoxShadow(
