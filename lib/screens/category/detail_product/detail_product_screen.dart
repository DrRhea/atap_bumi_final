...
class DetailProductScreen extends StatelessWidget {
  ...
  const DetailProductScreen({super.key, required this.equipment});

  int calculateRentalDays(DateTime start, DateTime end) {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (equipment.featuresAdvantages != null &&
                  equipment.featuresAdvantages!.isNotEmpty) ...[
                Padding(
                  padding: const EdgeInsets.only(
                    left: 16.0,
                    right: 16.0,
  ...
  void _showAddToCartDialog(BuildContext context) {
    ...
    DateTime endDate = DateTime.now().add(
      Duration(days: equipment.minimumRentalDays + 1),
    );
    int quantity = 1;
                                      ...
                                      onTap: () async {
                                        final picked = await showDatePicker(
                                          ...
                                          firstDate: startDate.add(
                                            Duration(
                                              days: equipment.minimumRentalDays,
                                            ),
                                          ),
                                          lastDate: DateTime.now().add(
                                            const Duration(days: 365),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      'Duration: ${calculateRentalDays(startDate, endDate)} days',
                                      style: const TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600,
                                        color: Color(0xFF7CB342),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Rp ${_formatPrice(equipment.rentalPricePerDay * quantity * calculateRentalDays(startDate, endDate))}',
                                          style: const TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w700,
                                            color: Color(0xFF7CB342),
                                ...
                                onPressed:
                                    cartProvider.isLoading
                                        ...
                                        : () async {
                                          ...
                                          if (equipment.stock != null &&
                                              equipment.stock!.isNotEmpty) {
                                            // Cari stock yang available dan memiliki quantity yang cukup
                                            try {
                                              availableStock = equipment.stock!
                                                  .firstWhere(
                                                    (stock) =>
                                                        stock.isAvailable &&
                                          ...
                                          if (availableStock == null) {
                                            ScaffoldMessenger.of(
                                              ...
                                              const SnackBar(
                                                content: Text(
                                                  'No stock available for this equipment',
                                                ),
