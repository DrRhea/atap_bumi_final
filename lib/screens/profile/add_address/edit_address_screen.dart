...
class _EditAddressScreenState extends State<EditAddressScreen> 
  ...
  void _populateFields() {
    ...
    _cityController.text = widget.address.cityDistrict;
    _districtController.text = widget.address.subDistrict;
  ...
  Future<void> _updateAddress() async {
    ...
    try {
      ...
      print('=== EDIT ADDRESS DEBUG ===');
      print('Address ID: ${widget.address.id}');
      print('Updated Address Data: $addressData');

      final success = await addressProvider.updateAddress(widget.address.id, addressData);

      if (success) {
        if (mounted) {
          _showSnackBar('Address updated successfully!', true);
      ...
      print('Edit Address Save Error: $e');
      if (mounted) {
